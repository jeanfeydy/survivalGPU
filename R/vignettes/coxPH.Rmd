...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  eval = require("survminer")
)
```


The Cox Proportional Hazard model[^cox1] [^cox2] is a regression model generally used in medical research to check the association between time to event and one or more covariables.
