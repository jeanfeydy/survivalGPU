...
You can use `ggforest()` function from `survminer` package to plot forestplot for Cox PH model. The confidence interval plotted is the confidence interval by the normal distribution (not bootstrap)

```{r}
library(survminer)
ggforest(model = coxphGPU_bootstrap,
         data = drugdata)
```
