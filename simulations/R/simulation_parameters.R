...
generate_experiment_parameters <- function(){
    ...
    n_patients_list <- c(50)#c(200,500,2000,5000,20000,50000,100000)#c(100,200,500,1000,2000,5000,10000,20000,50000,100000)#c(100,1000,10000)

    # Defintion of the target impact
    scenario_list =  c("exponential_scenario") #c("inverted_u_weight","early_peak_weight")#
    cutoff_list = c(180)
