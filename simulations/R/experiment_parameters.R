generate_parameters <- function(){
    ...
    experiment_name = "statistical_significance_exploration_100_5000"
    ...
    scenario_functions_list = c("exponential_scenario", "early_peak_scenario", "bi_linear_scenario") #, early_peak_scenario, inverted_u_scenario") #c("exponential_scenario")
    n_patients_list = c(500)#c(100,200,500,1000,2000,5000,10000,20000,50000,100000)#c(100,200,500,1000,2000,5000,10000) #,20000) #,50000,100000)#c(100,1000,10000,100000)##c(100,1000,10000,100000)#c(100,200,500,1000,2000,5000,10000,20000,50000,100000)#,10000)
    max_time_list = c(365)
