generate_parameters <- function(){
    ...
    n_patients_list = c(100,200,500,1000,2000,5000)#c(100,200,500,1000,2000,5000,10000,20000,50000,100000)#c(100,200,500,1000,2000,5000,10000) #,20000) #,50000,100000)#c(100,1000,10000,100000)##c(100,1000,10000,100000)#c(100,200,500,1000,2000,5000,10000,20000,50000,100000)#,10000)
    max_time_list = c(365)
