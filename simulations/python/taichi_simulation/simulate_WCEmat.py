...
def get_dataset(Xmat, wce_mat, HR_target):
    ...
    wce_id_indexes, events, FUP_tis = cpu_matching_algo(wce_mat, max_time,n_patients, HR_target) # wce_mat
    ...
    return df_wce, elapsed_matching_time,elapased_dataset_time 
